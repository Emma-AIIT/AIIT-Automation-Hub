...
export const env = createEnv({
  server: {
    ...
    // AIIT Business
    MAKE_WHATSAPP_AIIT_BIZ_PULL_GROUPS_WEBHOOK_URL: z.string().url().optional(),
    MAKE_WHATSAPP_AIIT_BIZ_SEND_MESSAGE_WEBHOOK_URL: z.string().url().optional(),
    MAKE_WHATSAPP_AIIT_BIZ_PULL_PARTICIPANTS_WEBHOOK_URL: z.string().url().optional(),
  ...
  runtimeEnv: {
    ...
    MAKE_WHATSAPP_AIIT_BIZ_PULL_GROUPS_WEBHOOK_URL: process.env.MAKE_WHATSAPP_AIIT_BIZ_PULL_GROUPS_WEBHOOK_URL,
    MAKE_WHATSAPP_AIIT_BIZ_SEND_MESSAGE_WEBHOOK_URL: process.env.MAKE_WHATSAPP_AIIT_BIZ_SEND_MESSAGE_WEBHOOK_URL,
    MAKE_WHATSAPP_AIIT_BIZ_PULL_PARTICIPANTS_WEBHOOK_URL: process.env.MAKE_WHATSAPP_AIIT_BIZ_PULL_PARTICIPANTS_WEBHOOK_URL,
