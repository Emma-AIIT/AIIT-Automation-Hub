...
export function Sidebar() {
  ...
  return (
    <aside
      className={`fixed left-0 top-0 bottom-0 flex flex-col z-40 overflow-hidden transition-[width] duration-300 ease-in-out ${collapsed ? 'w-[72px]' : 'w-[220px]'}`}
    >
      {/* Layered background */}
      ...
      {/* Brand */}
      <div className="relative px-3 pt-7 pb-6 flex items-center justify-center sm:justify-start">
        <Link href="/automations" className={`flex items-center gap-3 group ${collapsed ? 'justify-center w-full' : ''}`}>
